...
<?php 
function showmenu() {
	print '<a class="menu" href="?slug=videos/premiere">Premiere</a>';
	print '<a class="menu" href="?slug=videos/newest">Nyt på DR NU</a>';
	print '<a class="menu" href="?slug=videos/mostviewed">Mest sete</a>';
	print '<a class="menu" href="?slug=videos/lastchance">Udløber snart</a>';
	print '<a class="menu" href="?slug=programseries">Alle programmer</a>';
	#print '<a class="menu" href="?slug=videos/all">Alle videoer</a>';
	print "\n<p class='text_line'>&nbsp;</p>\n";
	return ;
}
...
function showseries() {
	...
	for($i=0; $i<$lng; $i++){             
		...
		$videolink = "?id=".$JsonContent[$i]["newestVideoId"];
